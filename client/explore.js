...
//             <h3 style="margin:0 0 15px 0; color:#059669;"> Edit Idea</h3>
...
//                 <button id="pop-save" style="background:#059669; color:white; border:none; padding:10px 20px; border-radius:6px; cursor:pointer;">Save</button>
//             </div>
//         </div>
//     `;
...
//                             }" data-title="${
//         item.title
//       }" data-cat="${cat}" data-desc="${
//         item.description
//       }"><i class="fa-regular fa-pen-to-square"></i></button>
//                             <button class="btn-icon del-btn" data-id="${
//                               item._id
...
//                                 : "fa-regular fa-heart"
//                             }" style="color:${
//         isLiked ? "#dc2626" : "#64748b"
//       };"></i> <span class="like-count">${item.likes || 0}</span>
//                         </span>
//                         <span class="cmt-btn" data-id="${
//                           item._id
//                         }" style="cursor:pointer;">
//                             <i class="fa-regular fa-comment"></i> <span class="cmt-count">${
//                               item.comments ? item.comments.length : 0
//                             }</span>
//                         </span>
//                     </div>
//                     <div class="cmt-box" style="${
//                       cmtsHTML ? "display:block;" : "display:none;"
//                     } max-height:120px; overflow-y:auto; background:#f8fafc; padding:10px; margin-top:12px; font-size:13px; border-radius:6px;">
//                         ${cmtsHTML}
//                     </div>
//                 </div>
//             `;
...
//         document.getElementById("pop-cat").value =
...
//                     alert(errData.message || "Failed to share idea. Try again!");
//                 }
//             } catch (err) {
